      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ob-input {
          ...
          border-radius: 12px; padding: 13px 16px; font-family: 'Outfit', sans-serif;
        ...
        .ob-textarea {
          width: 100%; background: rgba(255,255,255,0.05); border: 1.5px solid rgba(255,255,255,0.1);
          border-radius: 12px; padding: 13px 16px; font-family: 'Outfit', sans-serif;
          font-size: 14px; color: #fff; outline: none; resize: none; transition: border-color 0.2s;
        }
        .ob-textarea:focus { border-color: rgba(77,168,98,0.5); }
        .ob-textarea::placeholder { color: rgba(255,255,255,0.2); }
        .btn-primary {
          width: 100%; background: #2d7a42; border: none; border-radius: 14px;
          padding: 15px; font-family: 'Outfit', sans-serif; font-size: 15px; font-weight: 700;
          color: #fff; cursor: pointer; box-shadow: 0 2px 16px rgba(45,122,66,0.35);
      ...
      <div style={{ width: "100%", maxWidth: 480 }}>
        ...
        {step === 1 && (
          <div>
            ...
            <button className="btn-primary" onClick={saveStep1} disabled={saving || !displayName.trim()}>
              {saving ? (uploadingAvatar ? "Uploading photo..." : "Saving...") : "Next →"}
            </button>
          </div>
        )}
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: 8, marginBottom: 20 }}>
              {HANDICAP_BUCKETS.map(b => (
                <button
                  key={b.value}
                  onClick={() => { setHandicapBucket(b.value); setUseCustom(false); }}
                  style={{
                    padding: "12px 4px", borderRadius: 12, border: `1.5px solid ${!useCustom && handicapBucket === b.value ? "rgba(77,168,98,0.6)" : "rgba(255,255,255,0.1)"}`,
                    background: !useCustom && handicapBucket === b.value ? "rgba(77,168,98,0.15)" : "rgba(255,255,255,0.04)",
            ...
            <div style={{ marginTop: 8 }}>
              <button className="btn-primary" onClick={saveStep2} disabled={saving} style={{ marginBottom: 10 }}>
                {saving ? "Saving..." : "Next →"}
              </button>
