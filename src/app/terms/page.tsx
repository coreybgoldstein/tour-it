...
export default function TermsPage() {
  ...
  return (
    <div style={{ minHeight: "100svh", background: "#07100a", color: "#fff", fontFamily: "'Outfit', sans-serif" }}>
      {/* Header */}
      <div style={{ position: "sticky", top: 0, zIndex: 10, background: "#07100a", borderBottom: "1px solid rgba(255,255,255,0.06)", padding: "calc(14px + env(safe-area-inset-top)) 20px 14px", display: "flex", alignItems: "center", gap: 12 }}>
