...
const ALLOWED = new Set(["officialDescription", "websiteUrl", "teeSheetUrl", "membershipInquiryUrl", "logoUrl", "coverImageUrl"]);
...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  for (const urlField of ["websiteUrl", "teeSheetUrl", "membershipInquiryUrl", "logoUrl", "coverImageUrl"] as const) {
