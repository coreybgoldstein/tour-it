  ...
  return (
    <>
      <style>{`
        ...
        .cv-course-badge { width: 40px; height: 40px; border-radius: 10px; background: rgba(77,168,98,0.2); border: 1.5px solid rgba(0,0,0,0.55); display: flex; align-items: center; justify-content: center; font-family: 'Outfit', sans-serif; font-size: 11px; font-weight: 700; color: #4da862; flex-shrink: 0; overflow: hidden; }
        ...
        .cv-action-label { font-family: 'Outfit', sans-serif; font-size: 11px; font-weight: 700; color: rgba(255,255,255,0.75); }
        .cv-action-label-green { font-family: 'Outfit', sans-serif; font-size: 11px; font-weight: 700; color: #4da862; }
      ...
      <div style={{ position: "fixed", inset: 0, zIndex: 100, background: "#000" }}>
        ...
        <div className="cv-right-actions">
          ...
          <button className="cv-action-btn" onClick={toggleLike}>
            ...
            <span className="cv-action-label-green" style={{ textShadow: "0 1px 6px rgba(0,0,0,0.95)" }}>{likeCount}</span>
          </button>
          ...
          <button className="cv-action-btn" onClick={handleShare}>
            <div className="cv-action-icon" style={copied ? { borderColor: "rgba(77,168,98,0.5)", background: "rgba(77,168,98,0.15)" } : {}}>
              {copied
          ...
          {hasNotes && (
            <button className="cv-action-btn" onClick={() => setNotesOpen(true)}>
              ...
              <span className="cv-action-label" style={{ textShadow: "0 1px 6px rgba(0,0,0,0.95)" }}>Notes</span>
            </button>
          )}
        </div>
