...
export default function FromTheCourseBlock({ courseId, officialDescription, teeSheetUrl }: Props) {
  ...
  const hasContent = !!officialDescription || !!teeSheetUrl || staff.length > 0;
