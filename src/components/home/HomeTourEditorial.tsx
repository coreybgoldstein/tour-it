...
export default function HomeTourEditorial() {
  ...
  return (
    <main style={{ position: "relative", minHeight: "100dvh", background: SITE_BG, color: "#fff", paddingBottom: 110, paddingLeft: isDesktop ? 72 : 0 }}>
      {/* Editorial film-grain overlay — subtle fractal-noise texture over
          the continuous dark environment. pointer-events:none so it never
          intercepts taps; mix-blend overlay keeps it from washing content. */}
      <div
        aria-hidden
        style={{
          position: "fixed",
      ...
      <div style={{ padding: "12px 16px 0", maxWidth: isDesktop ? 720 : undefined, margin: isDesktop ? "0 auto" : undefined }}>
        ...
        >
          ...
          <span style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", lineHeight: 1.1 }}>
            <span style={{ fontFamily: "'Playfair Display', serif", fontSize: 17, fontWeight: 800, letterSpacing: "0.01em" }}>
              Tour It All
            </span>
...
function YourTourCard({
  ...
  return (
    ...
    >
          ...
          return (
            <div style={{ width: 32, height: 32, borderRadius: 0, background: "#fff", padding: 2.5, border: "1px solid rgba(255,255,255,0.6)", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", flexShrink: 0, boxShadow: "0 1px 3px rgba(0,0,0,0.3)" }}>
              {identitySrc ? (
                ...
                <span style={{ fontFamily: "'Playfair Display', serif", fontSize: 11, fontWeight: 800, color: "#0c1c13" }}>
      ...
      <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 18, fontWeight: 700, fontVariationSettings: "'opsz' 60", color: "#fff", lineHeight: 1.15, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", minWidth: 0, letterSpacing: "-0.005em" }}>
        {tour.stops.length <= 1 ? (tour.stops[0]?.course.name || tour.name) : tour.name}
      </div>

      {/* ── Meta block — two lines max ──────────────────────────────
          Row 1 = date (+ tee time on rounds).
          Row 2 = location · golfer count. */}
      <div style={{ display: "flex", flexDirection: "column", gap: 3, fontFamily: "'Outfit', sans-serif", fontSize: 11.5, color: "rgba(244,236,214,0.82)" }}>
      ...
      <div onClick={(e) => e.stopPropagation()} style={{ marginTop: "auto", paddingTop: 2 }}>
        {tour.game ? (
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0, fontFamily: "'Outfit', sans-serif", fontSize: 12, fontWeight: 700, color: "#fff", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", letterSpacing: "0.005em" }}>
              {(() => {
          ...
          >
            <GameScorecardIcon color="#7ed28b" size={18} />
            <div style={{ flex: 1, minWidth: 0, textAlign: "left", fontFamily: "'Outfit', sans-serif", fontSize: 12.5, fontWeight: 700, color: "rgba(220,245,226,0.95)", letterSpacing: "0.01em", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
              Create a game
            </div>
            <ChevronRightSage />
          </button>
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", display: "flex", flexDirection: "column", height: "100%", justifyContent: "space-between", gap: 8 }}>
        ...
        <div>
          <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 10, fontWeight: 800, letterSpacing: "0.14em", textTransform: "uppercase", color: "rgba(126,200,140,0.95)", marginBottom: 2 }}>
            Plan Another
          </div>
...
function NearMeRail({
  ...
  return (
    <section style={{ marginTop: 10 }}>
      ...
      {locStatus !== "granted" && (
        <div style={{ padding: "12px 14px", background: "rgba(244,236,214,0.02)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 0 }}>
          ...
          <button
            ...
            style={{
              ...
              background: "#4da862", border: "1px solid #4da862",
              fontFamily: "'Outfit', sans-serif", fontSize: 12, fontWeight: 700, color: "#07100a",
              cursor: "pointer",
            }}
          >
      ...
      {locStatus === "granted" && queried && courses.length === 0 && (
        <div style={{ padding: "16px", background: "rgba(244,236,214,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: 0, fontFamily: "'Outfit', sans-serif", fontSize: 13, color: "rgba(255,255,255,0.4)", textAlign: "center" }}>
    ...
    >
      ...
      <div style={{ padding: "9px 10px 11px" }}>
        ...
        {!!course.uploadCount && course.uploadCount > 0 && (
          <div style={{ marginTop: 6, fontFamily: "'Outfit', sans-serif", fontSize: 10, fontWeight: 700, color: "#4da862", letterSpacing: "0.16em", textTransform: "uppercase" }}>
    ...
    <div style={{ display: "flex", alignItems: "center", gap: 3, flexShrink: 0 }}>
        ...
        return (
          ...
          >
            {avatar ? (
              ...
              <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: 11, fontWeight: 800, color: "rgba(126,200,140,0.95)", letterSpacing: "0.02em" }}>
                {playerInitials(m)}
              </span>
            )}
          </div>
      ...
      {extra > 0 && (
        <div style={{
          ...
          <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: 10, fontWeight: 800, color: "rgba(255,255,255,0.85)" }}>
            +{extra}
          </span>
        </div>
      )}
...
function StatCell({ label, value }: { label: string; value: string }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", lineHeight: 1.05, minWidth: 0 }}>
      <span style={{ fontFamily: "'Outfit', sans-serif", fontSize: 8.5, fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase", color: "rgba(126,200,140,0.85)" }}>
        {label}
      </span>
      <span style={{ fontFamily: "'Playfair Display', serif", fontSize: 17, fontWeight: 700, fontVariationSettings: "'opsz' 60", color: "#fff", letterSpacing: "-0.005em", marginTop: 2 }}>
        {value}
      </span>
    </div>
  );
  ...
  return (
    <button
      ...
      style={{
        ...
        height: "100%",
        padding: "8px 12px",
        // Flat solid fill, sharp corners — the editorial button language.
        // Height matches the game-ready chip (44px) so the two states
  ...
  return (
    <div style={{ position: "absolute", inset: 0, background: "linear-gradient(145deg, #1c4425 0%, #0c2117 60%, #050d08 100%)", overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
        {logo ? (
          <div style={{ width: 88, height: 88, borderRadius: 0, background: "#fff", padding: 10, display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid rgba(255,255,255,0.6)", boxShadow: "0 6px 24px rgba(0,0,0,0.45)" }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={logo} alt="" style={{ width: "100%", height: "100%", objectFit: "contain" }} />
          </div>
        ) : (
          <div style={{ width: 86, height: 86, borderRadius: 0, background: "rgba(244,236,214,0.06)", border: "1px solid rgba(244,236,214,0.25)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Playfair Display', serif", fontSize: 32, fontWeight: 800, color: "rgba(244,236,214,0.7)", letterSpacing: "0.05em" }}>
