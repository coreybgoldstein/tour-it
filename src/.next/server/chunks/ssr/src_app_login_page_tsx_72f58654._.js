module.exports=[93482,a=>{"use strict";var b=a.i(87924),c=a.i(72131),d=a.i(50944),e=a.i(95445);function f(){let a=(0,d.useRouter)(),[f,g]=(0,c.useState)(""),[h,i]=(0,c.useState)(""),[j,k]=(0,c.useState)(!1),[l,m]=(0,c.useState)(""),n=async()=>{if(m(""),k(!0),!f||!h){m("Please enter your email and password."),k(!1);return}let b=(0,e.createClient)(),{data:c,error:d}=await b.auth.signInWithPassword({email:f,password:h});if(d){m("Invalid email or password. Please try again."),k(!1);return}let g=c.user?.id;if(g){let{data:c}=await b.from("User").select("username, displayName").eq("id",g).single();if(c&&c.displayName===c.username)return void a.push("/onboarding")}a.push("/")};return(0,b.jsxs)("main",{style:{minHeight:"100dvh",background:"#07100a",color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",padding:"20px"},children:[(0,b.jsx)("style",{children:`
      ...
      `}),(0,b.jsx)("div",{className:"bg-texture"}),(0,b.jsx)("div",{className:"bg-glow"}),(0,b.jsxs)("div",{className:"card",children:[(0,b.jsx)("img",{src:"/tour-it-logo-full.png",alt:"Tour It",style:{height:48,width:"auto",maxWidth:"100%",marginBottom:4}}),(0,b.jsx)("p",{className:"tagline",children:"Scout every hole before you play it."}),(0,b.jsx)("h1",{className:"title",children:"Welcome back"}),(0,b.jsx)("p",{className:"subtitle",children:"Log in to your Tour It account."}),l&&(0,b.jsx)("div",{className:"error-box",children:l}),(0,b.jsxs)("div",{className:"field",children:[(0,b.jsx)("label",{className:"field-label",children:"Email"}),(0,b.jsx)("input",{className:"field-input",type:"email",placeholder:"you@example.com",value:f,onChange:a=>g(a.target.value)})]}),(0,b.jsxs)("div",{className:"field",children:[(0,b.jsx)("label",{className:"field-label",children:"Password"}),(0,b.jsx)("input",{className:"field-input",type:"password",placeholder:"Your password",value:h,onChange:a=>i(a.target.value),onKeyDown:a=>"Enter"===a.key&&n()})]}),(0,b.jsx)("div",{className:"forgot",children:(0,b.jsx)("a",{href:"/forgot-password",children:"Forgot password?"})}),(0,b.jsx)("button",{className:"btn-submit",onClick:n,disabled:j,children:j?"Logging in...":"Log in"}),(0,b.jsx)("div",{className:"divider"}),(0,b.jsxs)("div",{className:"signup-link",children:["Don't have an account? ",(0,b.jsx)("a",{href:"/signup",children:"Sign up free"})]})]})]})}a.s(["default",()=>f])}];
